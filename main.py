...
parser.add_argument('--two_way', dest='two_way', action='store_true', default=False, help='Enable 2 way comms')
parser.add_argument('--color_restrictions', dest='color_restrict', action='store_true', default=False, help='Enable color restrictions')
